...
class ChatRoom(models.Model):
    creator = models.ForeignKey(Profile, on_delete=models.CASCADE, null=True, related_name='room_creator')
...
class Message(models.Model):
    ...
    def __str__(self):
        return self.author.Profilename
...
class VideoCall(models.Model):
    ...
    callee = models.ForeignKey(Profile, on_delete=models.CASCADE, related_name='callee')
